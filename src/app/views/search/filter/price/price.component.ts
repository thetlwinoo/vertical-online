import { Component, OnInit, Output, EventEmitter, ViewEncapsulation, Input, OnDestroy, OnChanges } from '@angular/core';
...
export class PriceComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnChanges(): void {
    if (this.priceRangeStream) {
      this.minPrice = this.priceRangeStream.minPrice;
      this.maxPrice = this.priceRangeStream.maxPrice;
