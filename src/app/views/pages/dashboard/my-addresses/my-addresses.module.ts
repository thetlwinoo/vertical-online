...
import { MyAddressesComponent, AddressesUpdateComponent, AddressComponent, addressesRoute } from './';

const ENTITY_STATES = [...addressesRoute];

@NgModule({
  imports: [RootSharedModule, RouterModule.forChild(ENTITY_STATES)],
  declarations: [MyAddressesComponent, AddressComponent, AddressesUpdateComponent],
