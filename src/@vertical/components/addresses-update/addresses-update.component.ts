...
import { IAddresses, IPeople, ICustomers, IZone, ICountries, ICities, IAddressTypes } from '@vertical/models';
...
import { CountriesService, CitiesService, ZoneService, AddressTypesService } from '@vertical/services';
