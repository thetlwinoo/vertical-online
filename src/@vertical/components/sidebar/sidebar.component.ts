...
import { RootConfigService, RootMatchMediaService } from '@vertical/services';
...
export class RootSidebarComponent implements OnInit, OnDestroy {
    ...
    private _setupVisibility(): void {
        // Remove the existing root-shadow
        this._renderer.setStyle(this._elementRef.nativeElement, 'root-shadow', 'none');
